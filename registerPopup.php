    ...
    <body>
   	...
   	<form action="tools/register.php" method="post" class="registerForm">
   		...
   		<div class="registerFormLine">
   			...
   			<input type="email" name="email" id="registerFormEmail" class="registerFormField input w100" placeholder="Email" maxlenght="256" onchange="registerFormCheckConfirmEmail()">
   		</div>
   		<div>
   		...
   		<div class="registerFormLine">
            ...
            <div class="registerFormSubmitButtonDiv">
                <button type="button" class="registerFormSubmitButton button w100 mt15" onclick="hideRegisterPopup()">Cancel</button>
            </div>
        </div>
   	</form>
	</div> 
