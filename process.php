...
if( isset($_POST) ){
    ...
    if(empty($email)){
        $formok = false;
        $errors[] = "You have to enter an email address";
    ...
    if(empty($message)){
        $formok = false;
        $errors[] = "You have to enter a message";
    }
    //validate message is greater than 20 characters
    elseif(strlen($message) < 20){
        $formok = false;
        $errors[] = "Your message must contain more than 20 characters";
    }
    ...
    if($formok){
        ...
        mail("eatincork.project@gmail.com","New Enquiry",$emailbody,$headers);
